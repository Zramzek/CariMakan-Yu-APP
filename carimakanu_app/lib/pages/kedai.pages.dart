...
class KedaiPage extends StatelessWidget {
  // const KedaiPage({Key? key, required this.kedai}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(
                height: 8), // Add some spacing between title and image
            ...
            Padding(
              ...
              //   style: TextStyle(
              //       fontSize: 14, color: Colors.black54, fontFamily: 'Lexend'),
              // ),
            ),
